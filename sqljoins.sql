...
SELECT o.first_name,o.last_name,count(o.id) 
FROM owners o
JOIN vehicles v
ON o.id = v.owner_id
...
SELECT o.first_name,o.last_name,ROUND(AVG(v.price)) as car_avg,count(o.id) as car_count
FROM owners o
LEFT JOIN vehicles v
ON o.id = v.owner_id
group by first_name, last_name
having count(o.id) > 1 AND round(avg(v.price)) > 10000 order by first_name DESC;
